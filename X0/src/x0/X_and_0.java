 ...
 * @author Yatharth
 */
public class X_and_0 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(X_and_0.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
